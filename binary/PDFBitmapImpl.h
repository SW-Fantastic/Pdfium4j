...
#include "Platform.h"
/* Header for class org_swdc_pdfium_internal_PDFBitmapImpl */

#ifndef _Included_org_swdc_pdfium_internal_PDFBitmapImpl
#define _Included_org_swdc_pdfium_internal_PDFBitmapImpl
#ifdef __cplusplus
extern "C" {
#endif
/*
